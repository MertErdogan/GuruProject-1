...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "Third-Party/SimpleFolderIcon/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/Third-Party/SimpleFolderIcon/Icons/{f.Name}", typeof(Texture2D));
